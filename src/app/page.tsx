            ...
            features={[
              {
                ...
                title: "Browser Extension Alerts",
                subtitle: "Real-time misinformation warnings as you browse",
                description:
              ...
              },
              {
                ...
                subtitle: "Submit media for expert and community review",
                description:
              ...
              },
              {
                ...
                title: "Multilingual AI Scanner",
                subtitle: "Detect biases, deepfakes, and logical fallacies",
                description:
              ...
              },
              {
                ...
                title: "Interactive Fact Trails",
                subtitle: "Track claim evolution and corrections over time",
                description:
                  "Visualize how claims spread, mutate, and get corrected. Educational timelines show original sources, fact-checks, corrections, and the impact of misinformation—building media literacy in real-time.",
                imageSrc:
                  "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_3AZh30Qi21tuT4ekNerkSR6qP3y/interactive-timeline-visualization-showi-1772806230963-7d4c4c10.png",
                imageAlt: "Interactive timeline showing claim evolution",
                buttons: [
                  {
              ...
              {
                id: 5,
                tag: "Global Watchlist",
                title: "Live Topic Monitoring",
                subtitle: "User-voted trending topics with live feeds",
                description:
              ...
              },
              {
                ...
                subtitle: "Prevent rumors from hindering disaster aid",
                description:
                  "During humanitarian crises, rapid misinformation detection prevents false narratives from disrupting aid efforts. Real-time verification protects vulnerable populations and ensures accurate emergency information reaches those who need it most.",
                imageSrc:
                  "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_3AZh30Qi21tuT4ekNerkSR6qP3y/humanitarian-crisis-response-interface-s-1772806230569-34630b3e.png",
                imageAlt: "Crisis response and humanitarian aid verification",
                buttons: [
                  {
                    text: "Our Impact",
                    href: "#impact",
            ...
            metrics={[
              {
                ...
                title: "%",
                description:
                  "Potential reduction in misinformation spread during key events",
                icon: TrendingDown,
              },
              {
                id: "2",
                ...
                title: "+",
                description:
                  "Countries where TruthGuard can protect democracy and citizens",
                icon: Globe,
              },
              {
                id: "3",
                ...
                title: "K+",
                description:
                  "Excess COVID deaths prevented by rapid fact-checking (2023-2024)",
                icon: Heart,
              },
              {
                id: "4",
                value: "500",
                title: "%",
                description: "Annual growth in AI-generated deepfakes we detect",
                icon: Zap,
              },
            ]}
          />
            ...
            testimonials={[
              {
                ...
                quote:
                  "TruthGuard's crowdsourced verification platform cut our fact-checking time by 60%. We can now respond to false narratives within hours instead of days.",
              ...
              },
              {
                ...
                quote:
                  "During the election crisis in our region, TruthGuard detected 87% of false voting rumors before they spread. It genuinely protected democratic integrity.",
                name: "James Okonkwo",
              ...
              },
              {
                ...
                quote:
                  "When the hurricane hit, misinformation spread faster than real information. TruthGuard's real-time verification meant accurate aid information reached people who needed it most.",
                name: "Elena Volkov",
              ...
              },
              {
                ...
                quote:
                  "Our students use TruthGuard's fact trails to understand how misinformation spreads. It's the best educational tool we've found for teaching critical thinking.",
              ...
              },
              {
                ...
                quote:
                  "Most misinformation tools have Western bias. TruthGuard's diverse training data and cultural nuance scoring finally makes verification fair for our Asian market.",
                name: "Chen Wei",
              ...
              },
              {
                ...
                quote:
                  "We deployed TruthGuard's open-source core at our NGO. The transparency and scalability let us protect 50 countries with minimal resources.",
                name: "Kwame Mensah",
        ...
        <div className="mx-auto px-4 md:px-6">
          <FaqBase
            ...
            faqs={[
              {
                id: "1",
                title: "How does TruthGuard handle free speech concerns?",
                content:
              ...
              {
                id: "2",
                title: "What about cultural bias in the AI?",
                content:
              ...
              {
                id: "3",
                title: "How is TruthGuard funded?",
                content:
              ...
              {
                id: "4",
                title: "Can TruthGuard detect all deepfakes?",
                content:
              ...
              {
                id: "5",
                title: "How do you prevent trolls from gaming the verification system?",
                content:
              ...
              {
                id: "6",
                title: "What data does TruthGuard collect from users?",
                content:
              ...
              {
                id: "7",
                title: "How quickly does TruthGuard detect new misinformation?",
                content:
              ...
              {
                id: "8",
                title: "Can organizations customize TruthGuard for their needs?",
                content:
      ...
      <div id="contact" data-section="contact" className="py-24 bg-background">
        <div className="mx-auto px-4 md:px-6">
          <ContactCenter
            ...
            description="Join thousands of fact-checkers, journalists, and citizens using TruthGuard to combat misinformation. Start your free trial today or contact us about enterprise solutions."
            tagIcon={Mail}
